...
public class Addon implements Cloneable {
    ...
    public Addon(@Nonnull String name, @Nonnull String uniqueId, boolean required) {
        this.name = name;
        this.uniqueId = uniqueId;
        this.required = required;
    }

    public Addon(@Nonnull String name, @Nonnull String uniqueId) {
    ...
    public boolean equals(Object o) {
        ...
        Addon addon = (Addon) o;
        return name.equals(addon.name) && uniqueId.equals(addon.uniqueId);
    }
