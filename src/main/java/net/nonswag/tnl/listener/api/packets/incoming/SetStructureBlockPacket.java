...
@Getter
@Setter
public class SetStructureBlockPacket implements IncomingPacket {
    @Nonnull
    ...
    public SetStructureBlockPacket(@Nonnull BlockPosition position, @Nonnull Type type, @Nonnull Mode mode,
